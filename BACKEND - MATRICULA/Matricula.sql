...
SELECT C.codCurso, C.nombreCurso, C.pesoCreditos, HM.numeroVeces, C.codTipoCurso, E.numeroCreditos
...
SELECT  T.codTurno,T.numeroTurno,T.fechaTurno, T.horaInicioTurno, T.horaFinTurno,T.tipoTurno
                    FROM Estudiante E
                    INNER JOIN Turno T
