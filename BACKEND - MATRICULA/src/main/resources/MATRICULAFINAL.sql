...
SELECT  C.codCurso, C.nombreCurso,S.codSeccion, U.apellidoPaterno, U.apellidoMaterno, 
...
SELECT C.codCurso, C.nombreCurso, C.pesoCreditos, S.numVacantes, C.imagenSilabo
FROM Curso C
...
AND codSeccion = 'V';
SELECT * from seccion;
-- Debe de estar conectado directamente con la capa de actualizar vacantes
